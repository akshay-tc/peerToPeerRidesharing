      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img className="object-cover object-center rounded" alt="hero" src="/bg3.png" />
          </div>
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Get Started with Ride Sharing
              <br className="hidden lg:inline-block" />We use blockchain to make it Secure
            </h1>
            <p className="mb-8 leading-relaxed">
              BlockShare provides you with a secure and transparent ride sharing experience. We use blockchain to make sure that your data is safe and secure. We also use blockchain to make sure that you are getting the best deal possible.
            </p>
            <div className="flex justify-center">
              <a href="/DriverRegistration"><button className="inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Become a Driver</button></a>
              <a href="/PassengerRegistration"><button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Become a Rider</button></a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Importance of blockchain</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Blockchain is a decentralized technology that allows us to store data in a secure and transparent way. We use blockchain to make sure that your data is safe and secure. We also use blockchain to make sure that you are getting the best deal possible.
            </p>
          </div>
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">How you can get started</h2>
                <p className="leading-relaxed">Just follow these few simple steps and you will be ready to start your journey</p>
              </div>
            </div>
          </div>
          <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Be a Passenger</h2>
                <p className="leading-relaxed">If you are rider. Register yourself as the passenger. Provide your necessary details and we are good to go</p>
              </div>
            </div>
          </div>
          <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Be a Driver</h2>
                <p className="leading-relaxed">If you are looking to share your ride or provide your service. Get yourself registered as a driver</p>
              </div>
            </div>
          </div>
          <div className="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Login</h2>
                <p className="leading-relaxed">Once you are registered you can login. And you will get a dashboard for self from where you can track, follow and order your rides</p>
              </div>
            </div>
          </div>
        </div>
...
//   Welcome to <a href="#">Decentralised Ridesharing</a>!
// </h1>

// <p className={styles.description}>
//   Get started by Registering yourself with us.
// </p>
...
//     <h2>Be a Driver</h2>
//     <p>
//       Register yourself as a driver and start earning money by
//       sharing your ride.
//     </p>
//   </a>
...
//     <h2>Be a Rider</h2>
//     <p>
//       Register yourself as a rider and save your money by
//       sharing your ride.
//     </p>
//   </a>
